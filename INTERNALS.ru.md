# Внутреннее устройство
  ...
  * [Как добавить новое Netflow-поле](#как-добавить-новое-netflow-поле)
...
В коллекторе используются [https://ru.wikipedia.org/wiki/Скользящая_средняя#Кумулятивное_скользящее_среднее](куммулятивные скользящие средние)

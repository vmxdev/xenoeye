...
Производительность действительно важна для коллекторов. Когда скорости не хватает, обычно просто увеличивают частоту семплирования на роутере. Но чем выше частота семплирования, тем меньше точность данных.
...
Формально мы не можем назвать свой коллектор «быстрым» или хотя бы «высокопроизводительным», поэтому решили назвать его "легким".

Тем не менее, пользователи обычно интересуются хотя бы грубой оценкой производительности, поэтому вот несколько цифр.
